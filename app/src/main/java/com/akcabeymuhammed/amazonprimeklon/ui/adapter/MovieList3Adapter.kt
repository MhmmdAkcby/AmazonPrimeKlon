...
class MovieList3Adapter(var mContext: Context, var moveiList:List<Movies>)
    :RecyclerView.Adapter<MovieList3Adapter.DownloadTasarimTutucu>() {
    ...
    override fun onBindViewHolder(holder:DownloadTasarimTutucu, position:Int){
        var movie = moveiList.get(position)
