...
class MovieList6Adapter(var mContext:Context, var movieList6:List<Movies>)
    :RecyclerView.Adapter<MovieList6Adapter.DownloadTasarimTutucu>(){
    ...
    override fun onBindViewHolder(holder:DownloadTasarimTutucu, position: Int) {
        val movie = movieList6.get(position)
