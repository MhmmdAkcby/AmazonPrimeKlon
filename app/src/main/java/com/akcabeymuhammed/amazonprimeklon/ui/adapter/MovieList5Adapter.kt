...
class MovieList5Adapter(var mContext:Context, var movieList5:List<Movies>)
    :RecyclerView.Adapter<MovieList5Adapter.DownloadTasarimTutucu>(){
    ...
    override fun onBindViewHolder(holder: DownloadTasarimTutucu, position: Int) {
        val movie = movieList5.get(position)
